...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "about":
        await query.message.edit_text(
            text = f"<b>○ ᴏᴡɴᴇʀ : <a href='tg://user?id={OWNER_ID}'>DENJI</a>\n○ ᴍʏ ᴜᴘᴅᴀᴛᴇs : <a href='https://t.me/Kdrama_Time'>Kdrama Time</a>\n○ ᴍᴏᴠɪᴇs ᴜᴘᴅᴀᴛᴇs : <a href='https://t.me/+Boj9z0Ejf0Q5OGUx'>Movies Cosmos</a>\n○ ᴏᴜʀ ᴄᴏᴍᴍᴜɴɪᴛʏ : <a href='https://t.me/addlist/dWz5HuzPHrkwY2M1'>Team Kdrama Time</a>\n○ ᴀɴɪᴍᴇ ᴄʜannel : <a href='https://t.me/anime_cosmos_kdt'>Anime Cosmos</a></b>",
            disable_web_page_preview = True,
            reply_markup = InlineKeyboardMarkup(
                [
                    [
                    InlineKeyboardButton("⚡️ ᴄʟᴏsᴇ", callback_data = "close"),
                    InlineKeyboardButton('🍁 Promotion', url='https://t.me/goel_hehe')
                    ]
                ]
            )
        )
